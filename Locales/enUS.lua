...
L["tag_curhp"] = "Displays the current amount."
L["tag_curhp:short"] = "Displays the current amount as a shortvalue."
L["tag_perhp"] = "Displays the current amount as a percentage."
L["tag_perhp:short"] = "Displays the current amount as a percentage without decimals."

L["tag_maxhp"] = "Displays the maximum amount."
L["tag_maxhp:short"] = "Displays the maximum amount as a shortvalue."

L["tag_abs"] = "Displays the amount of absorbs."
L["tag_abs:short"] = "Displays the amount of absorbs as a shortvalue."
L["tag_perabs"] = "Displays the absorbs as a percentage."
L["tag_perabs:short"] = "Displays the absorbs as a percentage without decimals."

L["tag_curhp:abs"] = "Displays the current amount and absorbs."
L["tag_curhp:abs:short"] = "Displays the current amount and absorbs as shortvalues."
L["tag_perhp:perabs"] = "Displays the current amount and absorbs as percentages."
L["tag_perhp:perabs:short"] = "Displays the current amount and absorbs as percentages without decimals."

L["tag_curhp:abs:merge"] = "Displays the sum of the current amount and absorbs."
L["tag_curhp:abs:merge:short"] = "Displays the sum of the current amount and absorbs as a shortvalue."
L["tag_perhp:perabs:merge"] = "Displays the sum of the current amount and absorbs as a percentage."
L["tag_perhp:perabs:merge:short"] =
"Displays the sum of the current amount and absorbs as a percentage without decimals."

L["tag_defhp"] = "Displays the deficit."
L["tag_defhp:short"] = "Displays the deficit as a shortvalue."
L["tag_perdefhp"] = "Displays the deficit as a percentage."
L["tag_perdefhp:short"] = "Displays the deficit as a percentage without decimals."

L["tag_healabs"] = "Displays the amount of heal absorbs."
L["tag_healabs:short"] = "Displays the amount of heal absorbs as a shortvalue."
L["tag_perhealabs"] = "Displays the amount of heal absorbs as a percentage."
L["tag_perhealabs:short"] = "Displays the amount of heal absorbs as a percentage without decimals."
