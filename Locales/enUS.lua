...
L["tag_perhp:short"] = "Displays the current HP as a percentage without decimals."
...
L["tag_abs:short"] = "Displays the current amount of absorbs as a shortvalue."
L["tag_perabs"] = "Displays the current amount absorbs as a percentage."
L["tag_perabs:short"] = "Displays the current amount absorbs as a percentage without decimals."

L["tag_curhp:abs"] = "Displays the current HP and absorbs."
L["tag_curhp:abs:short"] = "Displays the current HP and absorbs as shortvalues."
L["tag_perhp:perabs"] = "Displays the current HP and absorbs as percentages."
L["tag_perhp:perabs:short"] = "Displays the current HP and absorbs as percentages without decimals."

L["tag_curhp:abs:merge"] = "Displays the sum of the current HP and absorbs."
L["tag_curhp:abs:merge:short"] = "Displays the sum of the current HP and absorbs as a shortvalue."
L["tag_perhp:perabs:merge"] = "Displays the sum of the current HP and absorbs as a percentage."
L["tag_perhp:perabs:merge:short"] =
"Displays the sum of the current HP and absorbs as a percentage without decimals."

L["tag_defhp"] = "Displays the current HP deficit."
L["tag_defhp:short"] = "Displays the current HP deficit as a shortvalue."
L["tag_perdefhp"] = "Displays the current HP deficit as a percentage."
L["tag_perdefhp:short"] = "Displays the current HP deficit as a percentage without decimals."
...
L["tag_perpp:short"] = "Displays the current power as a percentage without decimals."
...
L["tag_defpp:short"] = "Displays the power deficit as a shortvalue."
L["tag_perdefpp"] = "Displays the power deficit as a percentage."
L["tag_perdefpp:short"] = "Displays the power deficit as a percentage without decimals."
